...
function [EEG] = prepstep_removechannels(EEG, data_info, params_info, verbose)
    ...
    %
    % Description: Removes specified channels from EEG data if specified in the preprocessing parameters.
    %
    % Syntax:
    ...
    %   - data_info (struct): Struct containing information about data, including channels to remove.
