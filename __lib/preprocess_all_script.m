...
params_info = struct('low_freq',0.1,...                          %filtering                              
                                 ...
                                 'windowC',0.25,...                        %2° ASR
                                 'burstR','on',...                             %2° ASR
                                 'th_reject',1000,...                        %amplitude threshold in uV
...
path_info = struct( 'datasets_path', p.Results.datasets_path, ...  
                                       ...
                                       'output_set_path', output_set_path, ... 
                                       'current_path', pwd, ... 
                                       ...
                                       'root_folder_path', output_path, ...
                                       'root_datasets_path', root_datasets_path, ...
                                       'root_data_path', output_path ... 
                                     );
