...
selection_info = struct('sub_i',[],...
                        ...
                        'subjects_totake',{{}},...
                        'session_totake',{{}},...
                        'task_totake', {{'run-4','run-8','run-12'}});
...
if ~strcmp(setting_name, 'default')
    path_info = load_settings(setting_name, 'path');
