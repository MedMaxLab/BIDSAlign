...
dataset_name = ['Nencki_Sym'];  % Set the name of the current dataset
...
params_info = struct('low_freq',0.5,...                          %filtering                              
                     'high_freq',40, ...                          %filtering
                     ...
                     'windowC',0.25,...                        %2° ASR
                     'burstR','off',...                             %2° ASR
                     'th_reject',250000,...                        %amplitude threshold in uV
