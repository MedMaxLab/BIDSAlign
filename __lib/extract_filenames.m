...
function [data_info] = extract_filenames(check_ch0_root, check_ch1_root, check_ch2_root, ...
    ...
    if ~isempty(data_info.channel_location_filename)
    ...
    elseif length(check_el0_root)==1
    ...
    elseif isempty(check_el2_root)
        data_info.electrodes_filename = [];
    end
    %|| (isempty(data_info.channel_location_filename) 
    %    else data_info.electrodes_filename = [data_info.dataset_path data_info.channel_location_filename];
