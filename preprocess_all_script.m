...
params_info = struct('dt_i',               5 , ...                % segment removal [s]
                     'dt_f',               5 , ...                % segment removal [s]
                     'sampling_rate',      250, ...               % resampling in [Hz]
                     'low_freq',           1 , ...                % filtering low freq                         
                     'high_freq',          45, ...                % filtering high freq
